...
export class DatetimePage implements OnInit {
  ...
  getCleanTime() {
    ...
    this.cleanYear = this.cleanTimeDate.getYear();
  ...
  cleanTimeTag() {
    ...
    if (this.cleanTimeInDays === 1) {
      ...
      if ((this.todayDay === this.cleanDay) && (this.todayMonth === this.cleanMonth) && (this.cleanYear !== this.todayYear) && ((this.todayYear - this.cleanYear) > 1)) {
        console.log('*****In CleanTimeTag******');
        console.log('cleanTimeInDays : ', this.cleanTimeInDays);
        ...
        console.log('cleanYear       : ', this.todayYear);
